		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p><strong><?php _e('Important Links:', 'mh-squared'); ?></strong>
					<a href="<?php echo esc_url('http://www.mhthemes.com/themes/mh/squared/'); ?>" target="_blank"><?php _e('Theme Info Page', 'mh-squared'); ?></a>
					<a href="<?php echo esc_url('http://www.mhthemes.com/support/'); ?>" target="_blank"><?php _e('Support Center', 'mh-squared'); ?></a>
				...
				<div class="row clearfix">
					<div class="col-1-2">
						<div class="section">
							...
							<p>
								<a href="<?php echo esc_url('http://www.mhthemes.com/support/documentation-mh-squared/'); ?>" target="_blank" class="button button-secondary"><?php _e('Visit Documentation', 'mh-squared'); ?></a>
							</p>
						</div>
						<div class="section">
						...
						<div class="section">
							...
							<p>
								<a href="<?php echo esc_url('http://www.mhthemes.com/members/login/'); ?>" target="_blank" class="button button-secondary"><?php _e('Login to MH Themes account', 'mh-squared'); ?></a>
							</p>
						</div>
					</div>
					<div class="col-1-2">
			...
			<hr>
			<div id="theme-author">
				<p><?php printf(__('%1s WordPress theme is proudly brought to you by %2s.', 'mh-squared'), $theme_data->Name, '<a target="_blank" href="http://www.mhthemes.com/" title="MH Themes">MH Themes</a>'); ?></p>
			</div>
		</div> <?php
	}
}
