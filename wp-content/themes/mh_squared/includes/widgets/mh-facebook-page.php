...
class mh_squared_facebook_page extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_squared_facebook_page', 'description' => esc_html__('Widget to display your Facebook page on your website.', 'mh-squared'))
		);
	}
    function widget($args, $instance) {
    	$defaults = array('title' => __('Follow on Facebook', 'mh-squared'), 'fb_url' => 'https://www.facebook.com/MHthemes', 'width' => 300, 'height' => 500, 'cover' => 0, 'faces' => 1, 'posts' => 0);
