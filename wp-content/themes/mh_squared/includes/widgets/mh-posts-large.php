...
class mh_squared_posts_large extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_squared_posts_large', 'description' => esc_html__('Display posts (large-sized) including thumbnail images.', 'mh-squared'))
		);
	}
						...
						<article <?php post_class('cp-large-item'); ?>>
							<div class="cp-large-thumb">
								<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
									<?php if (has_post_thumbnail()) { the_post_thumbnail('mh-squared-content'); } else { echo '<img class="mh-image-placeholder" src="' . get_template_directory_uri() . '/images/placeholder-large.png' . '" alt="No Image" />'; } ?>
								</a>
							</div>
