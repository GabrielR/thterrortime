...
class mh_squared_comments extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			array('classname' => 'mh_squared_comments', 'description' => esc_html__('MH Recent Comments widget to display your recent comments including user avatars.', 'mh-squared'))
		);
	}
    ...
    function form($instance) {
        $defaults = array('title' => __('Recent Comments', 'mh-squared'), 'number' => 5, 'offset' => 0);
