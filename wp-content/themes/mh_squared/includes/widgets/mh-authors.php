...
class mh_squared_authors extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_squared_authors', esc_html_x('MH Authors Widget', 'widget name', 'mh-squared'),
			array('classname' => 'mh_squared_authors', 'description' => esc_html__('MH Authors widget to display a list of authors including the number of published posts.', 'mh-squared'))
		);
	}
    ...
    function form($instance) {
        $defaults = array('title' => __('Authors', 'mh-squared'), 'authorcount' => 5, 'offset' => 0, 'role' => 0, 'orderby' => 'post_count', 'order' => 'DESC');
