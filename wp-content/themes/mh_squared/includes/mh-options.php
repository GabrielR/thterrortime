...
function mh_squared_customize_register($wp_customize) {
	...
	$wp_customize->add_panel('mh_squared_theme_options', array('title' => __('Theme Options', 'mh-squared'), 'description' => '', 'capability' => 'edit_theme_options', 'theme_supports' => '', 'priority' => 1,));

	/***** Add Sections *****/

	$wp_customize->add_section('mh_squared_general', array('title' => __('General', 'mh-squared'), 'priority' => 1, 'panel' => 'mh_squared_theme_options'));
	$wp_customize->add_section('mh_squared_layout', array('title' => __('Layout', 'mh-squared'), 'priority' => 2, 'panel' => 'mh_squared_theme_options'));
	$wp_customize->add_section('mh_squared_ticker', array('title' => __('News Ticker', 'mh-squared'), 'priority' => 3, 'panel' => 'mh_squared_theme_options'));
	$wp_customize->add_section('mh_squared_typo', array('title' => __('Typography', 'mh-squared'), 'priority' => 4, 'panel' => 'mh_squared_theme_options'));

	/***** Add Settings *****/

	$wp_customize->add_setting('mh_squared_options[favicon]', array('default' => '', 'type' => 'option', 'sanitize_callback' => 'esc_url_raw'));
	...
	$wp_customize->add_setting('mh_squared_options[read_more]', array('default' => 'Read More', 'type' => 'option', 'sanitize_callback' => 'mh_squared_sanitize_text'));
	...
	$wp_customize->add_setting('mh_squared_options[comments_pages]', array('default' => 'disable', 'type' => 'option', 'sanitize_callback' => 'mh_squared_sanitize_select'));
	...
	$wp_customize->add_setting('mh_squared_options[ticker_title]', array('default' => __('Latest', 'mh-squared'), 'type' => 'option', 'sanitize_callback' => 'mh_squared_sanitize_text'));
	...
	$wp_customize->add_setting('mh_squared_options[google_webfonts_subsets]', array('default' => 'latin', 'type' => 'option', 'sanitize_callback' => 'mh_squared_sanitize_select'));
	$wp_customize->add_setting('mh_squared_options[font_heading]', array('default' => 'quantico', 'type' => 'option', 'sanitize_callback' => 'esc_attr'));
	$wp_customize->add_setting('mh_squared_options[font_body]', array('default' => 'pt_sans', 'type' => 'option', 'sanitize_callback' => 'esc_attr'));
	$wp_customize->add_setting('mh_squared_options[font_styles]', array('default' => '400,700', 'type' => 'option', 'sanitize_callback' => 'mh_squared_sanitize_text'));
	...
	$wp_customize->add_control(new MH_Customize_Image_Control($wp_customize, 'favicon', array('label' => esc_html__('Favicon Upload', 'mh-squared'), 'section' => 'mh_squared_general', 'settings' => 'mh_squared_options[favicon]', 'priority' => 1)));
	...
	$wp_customize->add_control('credits', array('label' => esc_html__('Theme Credits', 'mh-squared'), 'section' => 'mh_squared_general', 'settings' => 'mh_squared_options[credits]', 'priority' => 5, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));

	$wp_customize->add_control('sidebar', array('label' => esc_html__('Sidebar Alignment', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[sidebar]', 'priority' => 1, 'type' => 'select', 'choices' => array('right' => __('Right Sidebar', 'mh-squared'), 'left' => __('Left Sidebar', 'mh-squared'))));
	$wp_customize->add_control('breadcrumbs', array('label' => esc_html__('Breadcrumb Navigation', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[breadcrumbs]', 'priority' => 2, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('featured_image', array('label' => esc_html__('Featured Image on Posts', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[featured_image]', 'priority' => 3, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('post_meta_cat', array('label' => esc_html__('Categories on Posts', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[post_meta_cat]', 'priority' => 4, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('post_meta_date', array('label' => esc_html__('Date on Posts', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[post_meta_date]', 'priority' => 5, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('post_meta_author', array('label' => esc_html__('Author Name on Posts', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[post_meta_author]', 'priority' => 6, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('post_meta_comments', array('label' => esc_html__('Comment Count on Posts', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[post_meta_comments]', 'priority' => 7, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('post_meta_tags', array('label' => esc_html__('Tags on Posts', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[post_meta_tags]', 'priority' => 8, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('social_sharing', array('label' => esc_html__('Sharing Buttons', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[social_sharing]', 'priority' => 9, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('author_box', array('label' => esc_html__('Author Box', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[author_box]', 'priority' => 10, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('related_content', array('label' => esc_html__('Related Articles', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[related_content]', 'priority' => 11, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('post_nav', array('label' => esc_html__('Post/Attachment Navigation', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[post_nav]', 'priority' => 12, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('comments_pages', array('label' => esc_html__('Comments on Pages', 'mh-squared'), 'section' => 'mh_squared_layout', 'settings' => 'mh_squared_options[comments_pages]', 'priority' => 13, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	...
	$wp_customize->add_control('google_webfonts', array('label' => esc_html__('Google Webfonts', 'mh-squared'), 'section' => 'mh_squared_typo', 'settings' => 'mh_squared_options[google_webfonts]', 'priority' => 2, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh-squared'), 'disable' => __('Disable', 'mh-squared'))));
	$wp_customize->add_control('google_webfonts_subsets', array('label' => esc_html__('Google Webfonts Characters', 'mh-squared'), 'section' => 'mh_squared_typo', 'settings' => 'mh_squared_options[google_webfonts_subsets]', 'priority' => 3, 'type' => 'select', 'choices' => array('latin' => __('Latin', 'mh-squared'), 'latin_ext' => __('Latin Extended', 'mh-squared'), 'greek' => __('Greek', 'mh-squared'), 'greek_ext' => __('Greek Extended', 'mh-squared'), 'cyrillic' => __('Cyrillic', 'mh-squared'), 'cyrillic_ext' => __('Cyrillic Extended', 'mh-squared'))));
	$wp_customize->add_control('font_heading', array('label' => esc_html__('Google Webfont for Headings', 'mh-squared'), 'section' => 'mh_squared_typo', 'settings' => 'mh_squared_options[font_heading]', 'priority' => 4, 'type' => 'select', 'choices' => $google_fonts));
	$wp_customize->add_control('font_body', array('label' => esc_html__('Google Webfont for Body Text', 'mh-squared'), 'section' => 'mh_squared_typo', 'settings' => 'mh_squared_options[font_body]', 'priority' => 5, 'type' => 'select', 'choices' => $google_fonts));
...
function mh_squared_sanitize_select($input) {
    $valid = array(
        'enable' => __('Enable', 'mh-squared'),
        'disable' => __('Disable', 'mh-squared'),
		'right' => __('Right Sidebar', 'mh-squared'),
        'left' => __('Left Sidebar', 'mh-squared'),
		'latin' => __('Latin', 'mh-squared'),
        'latin_ext' => __('Latin Extended', 'mh-squared'),
        'greek' => __('Greek', 'mh-squared'),
        'greek_ext' => __('Greek Extended', 'mh-squared'),
        'cyrillic' => __('Cyrillic', 'mh-squared'),
        'cyrillic_ext' => __('Cyrillic Extended', 'mh-squared')
    );
...
if (!function_exists('mh_squared_default_options')) {
	function mh_squared_default_options() {
		$default_options = array(
			'favicon' => '',
			'excerpt_length' => '25',
			'read_more' => __('Read More', 'mh-squared'),
			'copyright' => '',
			'credits' => 'enable',
			'breadcrumbs' => 'enable',
			...
			'sidebar' => 'right',
			'show_ticker' => 1,
			'ticker_title' => __('Latest', 'mh-squared'),
			'ticker_posts' => '5',
			'ticker_cats' => '',
			'ticker_tags' => '',
			'ticker_offset' => '',
